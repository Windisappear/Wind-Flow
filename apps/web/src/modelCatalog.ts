...
export const models:ModelItem[]=[
 ...
 {kind:'image',provider:'Google',value:'nano-banana-pro',label:'Nano Banana Pro'},{kind:'image',provider:'OpenAI',value:'image-2',label:'Image 2'},{kind:'image',provider:'火山方舟',value:'seedream-4.0',label:'Seedream 4.0'},
